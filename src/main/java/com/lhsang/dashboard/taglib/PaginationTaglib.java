package com.lhsang.dashboard.taglib;
...
public class PaginationTaglib extends SimpleTagSupport {
 ...
 private String next = "Next";
	 ...
	 public void doTag() throws JspException {
		  ...
		  try {
			  out.write("<div class=\"pag\">");
			   ...
			   for(int itr=0;itr<count+steps;itr+=steps) {
				    if(offset==itr)
				    	out.write(constructLink(itr, String.valueOf(itr/steps+1), "active", true));
				    else
				    	out.write(constructLink(itr, String.valueOf(itr/steps+1), null , false));
			   }
	 ...
	 private String constructLink(int page, String text, String className, boolean disabled) {
		  ...
		  link.append(" class=\"").append("page-item ");
		  if (className != null) {
