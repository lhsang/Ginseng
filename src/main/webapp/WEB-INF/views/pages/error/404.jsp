    ...
    <div class="card-body collapse in">
        ...
        <div class="row py-2">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <a href="/" class="btn btn-primary btn-block font-small-3"><i class="ft-home"></i> Back to Home</a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6">
                <a href="search-advanced.html" class="btn btn-danger btn-block font-small-3"><i class="ft-search"></i>  Advanced search</a>
            </div>
            </div>
        </div>
